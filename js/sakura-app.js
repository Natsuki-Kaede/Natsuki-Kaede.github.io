...
function checkBgImgCookie () {
  ...
  if (bgurl != '') {
    ...
    } else if (bgurl == 'https://random.flymc.top/random1.php') {
      mashiro_global.variables.skinSecter = true
...
$(document).ready(function () {
  ...
  changeBGnoTrans('#bing-bg', 'https://random.flymc.top/random1.php')
  ...
  $('.skin-menu #dark-bg').click(function () {
    mashiro_global.variables.skinSecter = true
    mashiro_global.variables.isNight = true
    $('body').css('background-image', 'url(https://cdn.jsdelivr.net/gh/Natsuki-Kaede/Blog-Resources/others/dark_bg9.jpg)')
    ...
    $('#banner_wave_2').addClass('banner_wave_hide_fit_skin')
    closeSkinMenu()
	setCookie('bgImgSetting','https://cdn.jsdelivr.net/gh/Natsuki-Kaede/Blog-Resources/others/dark_bg9.jpg',30)
  })
...
function add_copyright () {
  ...
  function setClipboardText (event) {
    ...
    var htmlData = '' + '本内容遵循 CC BY-NC-ND 4.0 版权协议。<br>' + '作者：' + 'FLY_MC' + '<br>' + '链接：' + window.location.href + '<br>' + '来源：' + mashiro_option.site_name + '<br><br>' + window.getSelection().toString().replace(/\r\n/g, '<br>')
    var textData = '' + '本内容遵循 CC BY-NC-ND 4.0 版权协议。\n' + '作者：' + 'FLY_MC' + '\n' + '链接：' + window.location.href + '\n' + '来源：' + mashiro_option.site_name + '\n\n' + window.getSelection().toString().replace(/\r\n/g, '\n')
    if (event.clipboardData) {
      event.clipboardData.setData('text/html', htmlData)
      event.clipboardData.setData('text/plain', textData)
      addComment.createButterbar('复制成功喵！<br>Copied to clipboard successfully!', 1000)
    ...
    VA: function () {
      if (!valine) {
        ...
        valine.init({
          ...
          serverURLs: mashiro_option.v_serverURLs,
